...
from wb.nm_helper.network_manager import (
    NM_ACTIVE_CONNECTION_STATE_ACTIVATING, NM_ACTIVE_CONNECTION_STATE_ACTIVATED,
    NM_ACTIVE_CONNECTION_STATE_DEACTIVATED, NM_ACTIVE_CONNECTION_STATE_UNKNOWN,
    NMConnection, NMActiveConnection,
)
...
class ConnectionManagerCheckTests(AbsConManCheckTests):
    ...
    def test_01_check_simple(self):
        ...
        with patch.object(self.con_man, "curl_get") as curl_get_mock:
            ...
            curl_get_mock.assert_has_calls([
                call("wb-eth0", self.con_man.config.connectivity_check_url)
            ])
    ...
    def test_02_check_one_skip_disconnected(self):
        ...
        with patch.object(self.con_man, "curl_get") as curl_get_mock:
            ...
            assert changed is True
            curl_get_mock.assert_has_calls([
                call("wb-eth1", self.con_man.config.connectivity_check_url),
            ])
    ...
    def test_04_check_wifi_ok(self):
        ...
        with patch.object(self.con_man, "curl_get") as curl_get_mock:
            ...
            curl_get_mock.assert_has_calls([
                call("wb-eth0", self.con_man.config.connectivity_check_url),
                call("wb-wifi-client", self.con_man.config.connectivity_check_url),
            ])
    ...
    def test_06_check_gsm_simple(self):
        ...
        with patch.object(self.con_man, "curl_get") as curl_get_mock:
            ...
            curl_get_mock.assert_has_calls([
                call("wb-eth0", self.con_man.config.connectivity_check_url),
                call("wb-eth1", self.con_man.config.connectivity_check_url),
                call("wb-gsm-sim1", self.con_man.config.connectivity_check_url),
            ])
    ...
    def test_07_check_gsm_change_slot_inactive(self):
        ...
        with patch.object(self.con_man, "curl_get") as curl_get_mock:
            ...
            curl_get_mock.assert_has_calls([
                call("wb-eth0", self.con_man.config.connectivity_check_url),
                call("wb-eth1", self.con_man.config.connectivity_check_url),
                call("wb-gsm-sim2", self.con_man.config.connectivity_check_url),
            ])
    ...
    def test_08_check_gsm_change_slot_active(self):
        ...
        self.net_man.add_ethernet("wb-eth1", device_connected=True)
        self.net_man.add_wifi_client("wb-wifi-client", device_connected=False)
        self.net_man.add_gsm("wb-gsm-sim1", device_connected=True,
                             connection_state=NM_ACTIVE_CONNECTION_STATE_ACTIVATED, sim_slot=1)
        self.net_man.add_gsm("wb-gsm-sim2", device_connected=True, sim_slot=2)
        with patch.object(self.con_man, "curl_get") as curl_get_mock:
            curl_get_mock.side_effect = ["", "", self.con_man.config.connectivity_check_payload]
...
class ConnectionManagerTests(AbsConManCheckTests):
    ...
    def test_03_get_active_connection_1(self):
        ...
        self.net_man.add_gsm("wb-gsm-sim1", device_connected=True,
                             connection_state=NM_ACTIVE_CONNECTION_STATE_ACTIVATED, sim_slot=1)
        self.net_man.add_gsm("wb-gsm-sim2", device_connected=True,
                             connection_state=NM_ACTIVE_CONNECTION_STATE_UNKNOWN, sim_slot=2)
    ...
    def test_04_get_active_connection_2(self):
        ...
        self.net_man.add_ethernet("wb-eth0", device_connected=True,
                                  connection_state=NM_ACTIVE_CONNECTION_STATE_ACTIVATED)
        self.net_man.add_ethernet("wb-eth1", device_connected=True,
                                  connection_state=NM_ACTIVE_CONNECTION_STATE_ACTIVATING)
    ...
    def test_05_activate_connection_eth(self):
        self._init_con_man(DEFAULT_CONFIG)
        self.net_man.add_ethernet("wb-eth0", device_connected=True, connection_state=NM_ACTIVE_CONNECTION_STATE_UNKNOWN)
    ...
    def test_07_activate_connection_gsm(self):
        self._init_con_man(DEFAULT_CONFIG)
        self.net_man.add_gsm("wb-gsm-sim1", device_connected=True,
                             state=NM_ACTIVE_CONNECTION_STATE_DEACTIVATED, sim_slot=1)
    ...
    def test_13_set_current_connection(self):
        ...
        with patch.object(self.con_man.timeouts, "now") as now_mock:
            ...
            new_tier, new_cn_id, changed = self.con_man.set_current_connection(active_cn, "wb-eth0", self.config.tiers[0])
            ...
            new_tier, new_cn_id, changed = self.con_man.set_current_connection(active_cn, "wb-gsm-sim1", self.config.tiers[2])
    ...
    def test_14_find_lesser_gsm_connections(self):
        ...
        self.net_man.add_gsm("wb-gsm-sim1", device_connected=True,
                             connection_state=NM_ACTIVE_CONNECTION_STATE_ACTIVATED, sim_slot=1)
        self.net_man.add_gsm("wb-gsm-sim2", device_connected=True,
                             connection_state=NM_ACTIVE_CONNECTION_STATE_ACTIVATED, sim_slot=2)
    ...
    def test_15_deactivate_lesser_gsm_connections_1(self):
        ...
        self.con_man.deactivate_lesser_gsm_connections(self.con_man.current_connection, self.con_man.current_tier)
